import { Satellite, Activity, Rocket, Brain, Menu, Globe2, Globe, Telescope, HouseIcon, Images } from "lucide-react";
...
const navItems = [
  ...
  { id: "weather", label: "Space News", icon: Activity, path: "/weather" },
